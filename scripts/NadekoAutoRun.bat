...
powershell -Command "Invoke-WebRequest https://github.com/Nielk1/NadekoBot/raw/dev/scripts/Latest.bat -OutFile '%FILENAME%'"
...
powershell -Command "Invoke-WebRequest https://github.com/Nielk1/NadekoBot/raw/dev/scripts/Stable.bat -OutFile '%FILENAME%'"
